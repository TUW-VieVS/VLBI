...
% % load vlbi picture
% picFile='../TRF/create/superstation/pics/VLBI_telescopePicture.jpg';
% if exist(picFile, 'file')
%     rgb=imread(picFile);
%     set(handles.figure_main, 'CurrentAxes', handles.axes_VLBIphoto);
%     image(rgb);
%     box off
%     axis off
% end
% 
% % UIWAIT makes createSuperstationsFile wait for user response (see UIRESUME)
% % uiwait(handles.figure_main);
% 
% % load search for files picture
% picSearchForFiles='../TRF/create/superstation/pics/searchForFiles_small.png';
% if exist(picSearchForFiles, 'file')
%     rgb=imread(picSearchForFiles, 'BackgroundColor',[1 1 1]);
%     set(handles.figure_main, 'CurrentAxes', handles.axes_searchForFiles);
%     image(rgb);
%     box off
%     axis off
% end
...
guiSateFile='../TRF/create/superstation/SavedGuiData_superstations.txt';
...
searchPath='../TRF/create/superstation/neededFiles/';
...
if isempty(curEditString)
    curEditString='../TRF/create/superstation/';
end
...
% handles.data.allFileDescriptions={'nsCodes', 'antennaInfo', 'antenna', 'eccdat', 'blokq', 'itrf2005', ...
%         'itrf2008', 'vtrf2008dat', 'mask', 'equip', 's12vandam', 's12gsfc', 'vlbidiscont', 'oceanLoadingFES2004', 'vievsTrf'};



% for all files -> write to one struct
for k=1:nInFiles
    % check if should be downloaded
    if get(eval(['handles.radiobutton_', handles.data.allFileDescriptions{k}, 'Download']), 'Value');
        switch handles.data.allFileDescriptions{k}
            case 'nsCodes'
                ...
                urlwrite(url, '../TRF/create/superstation/neededFiles/ns-codes.txt');
                inFiles(1).name='../TRF/create/superstation/neededFiles/ns-codes.txt';
            ...
            case 'antennaInfo'
                ...
                urlwrite(url, '../TRF/create/superstation/neededFiles/antenna-info.txt');
                inFiles(2).name='../TRF/create/superstation/neededFiles/antenna-info.txt';
                fprintf('File %s was downloaded\n', handles.data.allFileNames{k});
            case 'antenna'
                url='http://gemini.gsfc.nasa.gov/solve_save/antenna.dat';
                urlwrite(url, '../TRF/create/superstation/neededFiles/antenna.dat');
                inFiles(3).name='../TRF/create/superstation/neededFiles/antenna.dat';
                fprintf('File %s was downloaded\n', handles.data.allFileNames{k});
            case 'eccdat'
                url='http://gemini.gsfc.nasa.gov/solve_save/ECCDAT.ecc';
                urlwrite(url, '../TRF/create/superstation/neededFiles/ECCDAT.ecc');
                inFiles(4).name='../TRF/create/superstation/neededFiles/ECCDAT.ecc';
                fprintf('File %s was downloaded\n', handles.data.allFileNames{k});
            case 'blokq'
                url='http://gemini.gsfc.nasa.gov/apriori_files/blokq.dat';
                urlwrite(url, '../TRF/create/superstation/neededFiles/blokq.dat');
                inFiles(5).name='../TRF/create/superstation/neededFiles/blokq.dat';
                fprintf('File %s was downloaded\n', handles.data.allFileNames{k});
            case 'itrf2005'

                url='http://itrf.ensg.ign.fr/ITRF_solutions/2005/doc/ITRF2005_VLBI.SSC.txt';
                urlwrite(url, '../TRF/create/superstation/neededFiles/ITRF2005_VLBI.SSC.txt');
                inFiles(6).name='../TRF/create/superstation/neededFiles/ITRF2005_VLBI.SSC.txt';
                fprintf('File %s was downloaded\n', handles.data.allFileNames{k});
            case 'vlbidiscont'
                url='http://vlbi.geod.uni-bonn.de/IVS-AC/data/VLBI-DISCONT.txt';
                urlwrite(url, '../TRF/create/superstation/neededFiles/VLBI-DISCONT.txt');
                inFiles(7).name='../TRF/create/superstation/neededFiles/VLBI-DISCONT.txt';
                fprintf('File %s was downloaded\n', handles.data.allFileNames{k});   
            case 'itrf2008'
                url='http://itrf.ensg.ign.fr/ITRF_solutions/2008/doc/ITRF2008_VLBI.SSC.txt';
                urlwrite(url, '../TRF/create/superstation/neededFiles/ITRF2008_VLBI.SSC.txt');
                inFiles(8).name='../TRF/create/superstation/neededFiles/ITRF2008_VLBI.SSC.txt';
                fprintf('File %s was downloaded\n', handles.data.allFileNames{k});
            case 'vtrf2008dat'
            ...
            case 'ivstrf2014b'
                ...
                urlwrite(url, '../TRF/create/superstation/neededFiles/IVS_TRF2014b.SSC.txt');
                inFiles(11).name='../TRF/create/superstation/neededFiles/IVS_TRF2014b.SSC.txt';
                fprintf('File %s was downloaded\n', handles.data.allFileNames{k});
            case 'vieTrf13'
...
%         25'opoleloadcoefcmcor', 'opoleloadUserOwn', 'vievsTrf', 'userOwnTrf'
            ...
            case 'opoleloadcoefcmcor'
                ...
                urlwrite(url, '../TRF/create/superstation/neededFiles/opoleloadcoefcmcor.txt.gz');
                fprintf('File ../TRF/create/superstation/neededFiles/opoleloadcoefcmcor.txt.gz was downloaded,\nplease unzip manually to same folder and type ''return'' and hit enter!\nThanks!\n');
