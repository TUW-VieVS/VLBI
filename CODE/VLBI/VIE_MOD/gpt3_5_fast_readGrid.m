...
% function "gpt3_5_fast.m" must then replace the default "gpt3_5.m" at the 
% respective location in the text.
%
%
...
lat_grid  = C(:,1);            % latitude in °
lon_grid  = C(:,2);            % longitude in °
...
gpt3_grid = {lat_grid , lon_grid , p_grid, T_grid, Q_grid, dT_grid, u_grid, Hs_grid, ah_grid, aw_grid, la_grid, Tm_grid , Gn_h_grid , Ge_h_grid , Gn_w_grid , Ge_w_grid};
