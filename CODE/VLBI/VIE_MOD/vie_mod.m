...
%                         delphi  = phi;
                        ...
                        % dtds(2)=dtds0(1:3)*(sc_vel_crf/norm(sc_vel_crf));               % along track (falsch! => Hier gehò²´º cross(cross-track, radial), NICHT genau in v-Richtung!
