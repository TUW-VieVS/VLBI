...
%   26 Aug 2011 by Matthias Madzak, moved and simplified DD=zeros(1,6) --> DD = D;

function [FREQ PHASE] = libiers_tdfrph(IDOOD,mjd,leap)


%% changed according to VieVS
mjd_ref = 51544.5;       % 2000-01-01 at 12UT
T = (mjd - mjd_ref + (leap+32.184)/86400)/36525; 
DAYFR=(mjd-fix(mjd));  % [day]
