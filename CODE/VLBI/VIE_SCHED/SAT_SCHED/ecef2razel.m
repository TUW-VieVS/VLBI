...
%                           function ecef2razel
%
%  this function converts ECEF position and velocity
...
%    available.
%
%   NOTE: This function is based on the function "rv2razel" by Vallado.
%
%  author        : Andreas Hellerschiemied (2016-11-04)
%                   
%
%  revisions
%
...
%    ijk2ll      - Calculation of longitude, geod. latitude and altitude of the site (rs)
%
%  references    :
...
% function [rho,az,el,drho,daz,del] = ecef2razel ( reci,veci, latgd,lon,alt,ttt,jdut1,lod,xp,yp,terms,ddpsi,ddeps );
function [rho,az,el,drho,daz,del] = ecef2razel(recef, vecef, rs)
    ...
    % ---- Calc. longitude and geodetic latitide of the station ---
     [latgc, latgd, lon, hellp] = ijk2ll(rs);
...
%     [recef,vecef,aecef] = eci2ecef(reci,veci,a,ttt,jdut1,lod,xp,yp,terms,ddpsi,ddeps);
    ...
    drhoecef = vecef;           % [km]
%     rho      = mag(rhoecef);    % [km]
    rho      = norm(rhoecef);    % [km] % function mag.m replaced by the MATLAB function "norm"
