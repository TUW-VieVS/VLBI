...
if [ "$vgosDB" = "y" ]; then
	...
	rsync -avzh $user@vievs:/data/DATA4VLBI/DATA/vgosDB/$years* ../../DATA/vgosDB
else
	echo "skipping vgosDB"
fi
if [ "$radiate" = "y" ]; then
        echo "download RAYTRACING_DATA"
        rsync -avzh $user@vievs:/data/DATA4VLBI/TRP/RAYTRACING_DATA/$years* ../../TRP/RAYTRACING_DATA
else
        echo "skipping RAYTRACING_DATA"
fi
echo "download VMF1"
scp  $user@vievs:/data/DATA4VLBI/TRP/VMF1/y$years.vmf1_r ../../TRP/VMF1
echo "download VMF3"
scp  $user@vievs:/data/DATA4VLBI/TRP/VMF3/y$years.vmf3_r ../../TRP/VMF3
echo "download GRAD"
scp  $user@vievs:/data/DATA4VLBI/TRP/GRAD/y$years.grad_r ../../TRP/GRAD
