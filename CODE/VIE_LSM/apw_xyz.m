...
%   29 January 2025 by H. Wolf: added Warning that the piecewise linear
%                               estimation is currently not implemented to be carried out based on
%                               satellite and quasar observations separately
% ************************************************************************ 
function [Apwx,Apwy,Apwz] = apw_xyz(obs_per_stat,nobserv,nob,n_unk,T_)
    ...
    fprinft('WARNING: The estimation of piecewise linear offsets for station coordinates is not designed to be carried out based on solely satellite or quasar observations. Instead, all available observations are always used!\n')
